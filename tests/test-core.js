...
(function runCoreTests() {
    ...
    test('state has screenshots array', () => {
        assertTruthy(Array.isArray(window.state && window.state.screenshots), 'screenshots should be array');
    });

    test('state has selectedIndex', () => {
        assertTruthy(typeof (window.state && window.state.selectedIndex) === 'number', 'selectedIndex should be number');
    });

    test('state has defaults object', () => {
        assertTruthy(window.state && window.state.defaults, 'defaults should exist');
    ...
    test('state has projectLanguages array', () => {
        assertTruthy(Array.isArray(window.state && window.state.projectLanguages), 'projectLanguages should be array');
    });

    test('state has currentLanguage', () => {
        assertTruthy(typeof (window.state && window.state.currentLanguage) === 'string', 'currentLanguage should be string');
    });
    ...
    test('getCurrentScreenshot is defined', () => {
        assertTruthy(typeof window.getCurrentScreenshot === 'function', 'getCurrentScreenshot should be function');
    });
    ...
    test('getBackground is defined', () => {
        assertTruthy(typeof window.getBackground === 'function', 'getBackground should be function');
    });
    ...
    test('getScreenshotSettings is defined', () => {
        assertTruthy(typeof window.getScreenshotSettings === 'function', 'getScreenshotSettings should be function');
    });
    ...
    test('getScreenshotSettings returns object with required properties', () => {
        ...
        assertTruthy(typeof result.scale === 'number', 'Should have scale');
        assertTruthy(typeof result.x === 'number', 'Should have x');
        assertTruthy(typeof result.y === 'number', 'Should have y');
    });
    ...
    test('getTextSettings is defined', () => {
        assertTruthy(typeof window.getTextSettings === 'function', 'getTextSettings should be function');
    });
    ...
    test('formatValue is defined', () => {
        assertTruthy(typeof window.formatValue === 'function', 'formatValue should be function');
    });
    ...
    test('getCanvasDimensions is defined', () => {
        assertTruthy(typeof window.getCanvasDimensions === 'function', 'getCanvasDimensions should be function');
    });
    ...
    test('updateCanvas is defined', () => {
        assertTruthy(typeof window.updateCanvas === 'function', 'updateCanvas should be function');
    });
    ...
    test('syncUIWithState is defined', () => {
        assertTruthy(typeof window.syncUIWithState === 'function', 'syncUIWithState should be function');
    });
    ...
    test('MAX_FILE_SIZE is defined', () => {
        assertTruthy(typeof window.MAX_FILE_SIZE === 'number', 'MAX_FILE_SIZE should be number');
    ...
    test('debouncedSaveState is defined', () => {
        assertTruthy(typeof window.debouncedSaveState === 'function', 'debouncedSaveState should be function');
    });

    test('SAVE_DEBOUNCE_MS is defined', () => {
        assertTruthy(typeof window.SAVE_DEBOUNCE_MS === 'number', 'SAVE_DEBOUNCE_MS should be number');
